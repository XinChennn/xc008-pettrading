    ...
    <div v-if="nopet == false">
      <div class="maindetail container" v-if="photo.length > 0">
        <div class="photo">
          ...
          <div class="allimg">
            <div v-for="(item,index) in photo" :key="index" class="list" @mousemove="changeactive(index)" :class="{listactive: active===index}">
        ...
        <div class="message">
          ...
          <div class="but">
            <div class="chat" v-if="showchatimg" @click="tochat" @mouseover="overimg = true" @mouseleave="overimg = false">
              <!-- 禁止图片 -->
...
.listactive {
  border: 1px solid rgb(255, 93, 35, .4);
}
