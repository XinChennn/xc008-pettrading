    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-input v-model="form.username" clearable v-if="show === scope.$index" placeholder="请输入收件人"></el-input>
        </template>
      </el-table-column>
      <!-- 地址 -->
      <el-table-column
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <span v-if="show != scope.$index">
            <el-popconfirm title="确定删除该地址吗？" @onConfirm="deleteaddress(scope.$index,scope.row)">
...
<script>
  import {requestaddAddress,requestdeleteAddress,requestupdateAddress,requestqueryAddressbyuid} from "network/requestaddress.js"
