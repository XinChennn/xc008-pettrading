  ...
  <div class='petmanage'>
    <div class="selectbar">
      <el-form :inline="true" :model="form">
        ...
        <el-form-item label="宠物类型">
          <el-select @change="bkindchange" style="width: 100%" v-model="form.bkid" clearable filterable placeholder="宠物类型">
            <el-option
              v-for="item in bkind"
              :key="item.bkid"
        ...
        <el-form-item label="宠物品种">
          <el-select @change="skindchange" style="width: 100%" v-model="form.skid" clearable filterable placeholder="宠物品种">
            <el-option
        ...
        <el-form-item label="发布时间">
          <el-date-picker type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="form.date"></el-date-picker>
        </el-form-item>
        <el-form-item>
    ...
    <div>
      <el-table
        ...
        <el-table-column
          prop="bkind.bkindname"
          label="类型"
          width="100">
        </el-table-column>
        <el-table-column
          prop="skind.skindname"
          label="品种"
          width="100">
        </el-table-column>
        <el-table-column
    ...
    <el-drawer
      ...
      <div class="updatebar">
        ...
        label-width="80px">
         ...
         <el-form-item label="宠物类型">
          <el-select @change="updatebkindchange" style="width: 100%" v-model="updateform.bkid" clearable filterable placeholder="宠物类型">
            <el-option
              v-for="item in bkind"
              :key="item.bkid"
              :label="item.bkindname"
        ...
        <el-form-item label="宠物品种">
          <el-select @change="updateskindchange" style="width: 100%" v-model="updateform.skid" clearable filterable placeholder="宠物品种">
            <el-option
              v-for="item in fskind"
              :key="item.skid"
              :label="item.skindname"
          ...
          <el-form-item label="发布说明">
              <el-input type="textarea" placeholder="发布说明" clearable rows=4 resize="none" show-word-limit v-model="updateform.description"></el-input>
          </el-form-item>
          <el-form-item>
              <div class="but">
